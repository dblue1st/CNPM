...
//        txtPassword.setText(a.getPassWord());
    ...
    public void updatePassword() {
        Account acc = aDao.selectByIdUser(Auth.user.getIdUser());
        String oldPassword=acc.getPassWord();
        try {
            if(!oldPassword.equals(txtPassword.getText()))
                 MsgBox.warring(this, "Mật khẩu cũ không trùng khớp");
            else if (!Validate.checkEmpty(lblNewPassword, txtNewPassword, "Khổng bỏ trống mật khẩu mới")) {
                return;
            }else if (!Validate.checkEmpty(lblNewPassword, txtNewPassword, "Khổng bỏ trống mật khẩu mới")) {
                return;
