...
import com.ptithcm.DAO.CustomerDAO;
import com.ptithcm.DAO.StatisticalDAO;
import com.ptithcm.utils.XImage;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initCardData() {
        ...
        card2.setData(new ModelCard("Doanh thu/Tháng", sDao.getRevenueDate(), 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Sản phẩm /Tháng", sDao.getQuantityDate(), 80, icon3));
    ...
    private void initNoticeBoard() {
        ...
        noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(255, 51, 0), "Chính sách đổi trả", "2h ago", "Khi khách hàng gặp sự cố về sản phẩm lỗi bên shop như sản phẩm không vừa, hỏng, lỗi... Thời gian đổi trả trong vòng 2 ngày. Chi tiết liên hệ 0394297048"));
