...
import com.ptithcm.DAO.VoucherDAO;
import com.ptithcm.Validate.Validate;
import com.ptithcm.entity.Customer;
...
import com.ptithcm.entity.Voucher;
...
//     NumberFormat formatter = NumberFormat.getIntegerInstance(lc);
    ...
    InvoiceSell getInvoiceSell() {
        ...
        in.setStatusInvoice(true);
        in.setStatusPay(true);
