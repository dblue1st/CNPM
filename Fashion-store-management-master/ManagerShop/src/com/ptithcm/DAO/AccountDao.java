...
import com.ptithcm.entity.Account;
import com.ptithcm.helper.jdbcHelper;
...
public class AccountDao extends ShopDAO<Account, Integer> {
    ...
    private String SELECT_BY_USERNAME = "SELECT * FROM dbo.Account WHERE UserName = ?";
    ...
    public Account selectById(Integer k) {
        List<Account> list = this.selectBySql(SELECT_BY_USERNAME, k);
    ...
    public Account selectByUserName(String k) {
